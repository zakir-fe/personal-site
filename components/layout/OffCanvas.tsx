					...
					<div className="offCanvas__side-info mb-30">
						<div className="contact-list mb-30">
							...
							<div className="mb-3">
								...
								<p className="mb-0">+880 1718 297 506</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Email</span>
								<p className="mb-0">eng.zakirhossain4969@gmail.com</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Github</span>
								<p className="mb-0">EngZakirHossain</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Address</span>
								<p className="mb-0">Moddo Basaboo,Subujbag, Dhaka -1200</p>
							</div>
						</div>
