						...
						<div className="col-lg-5 d-flex flex-column ps-lg-8">
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">+880 1718 297 506</h6>
								</div>
								<a href="tel:+880 1718 297 506" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">eng.zakirhossain4969@gmail.com</h6>
								</div>
								<a href="mailto:eng.zakirhossain4969@gmail.com" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
										<i className="ri-github-line text-primary-2 fs-26" />
									</div>
								</div>
								<div className="ps-3 h-100">
									<span className="text-400 fs-6">Git</span>
									<h6 className="mb-0">EngZakirHossain</h6>
								</div>
								<a href="github.com/EngZakirHossain" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">Moddo Basaboo,Subujbag, Dhaka -1200</h6>
								</div>
