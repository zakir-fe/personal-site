										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2016-2020:</p>
													<div>
														<span className="text-primary-2">Daffodil International University</span>
											...
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Daffodil Institute Of IT</span>
														<p className="text-dark">Certification in Web Development and Woo-commerce Course</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Uttara Model College</span>
											...
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2006-2012:</p>
													<div>
														<span className="text-primary-2">Sacher High School </span>
														<p className="text-dark">Science</p>
													</div>
												</div>
											</li>											
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
								<div className="d-flex align-items-center">
									...
									<h2 className="mb-0 ms-2">Projects</h2>
								</div>
								<div className="d-flex flex-column h-100 position-relative mt-5">
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Advanced Home Security and Image Optimization</span>
													<p className="text-dark">Utilized Image Optimize and cloud for Home Security with advanced analytics and insights.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												<p className="text-300 text-nowrap fw-regular mb-0">2021-2022:</p>
												<div>
													<span className="text-primary-2">Pos And CMS  </span>
													<p className="text-dark">Studied best practices for designing applications Using Laravel and Rest APi.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												<p className="text-300 text-nowrap fw-regular mb-0">2021-2022:</p>
												<div>
													<span className="text-primary-2">Learning Advance Laravel and SQL </span>
													<p className="text-dark">Studied best practices of SQL</p>
												</div>
											</div>
										</li>
									</ul>
